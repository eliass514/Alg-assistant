...
export async function generateMetadata({ params }: PageProps) {
  const t = await getTranslations({ locale: params.locale, namespace: 'Auth.PasswordReset.meta' });
...
export default async function PasswordResetPage({ params, searchParams }: PageProps) {
  const page = await getTranslations({
    ...
    namespace: 'Auth.PasswordReset.page',
  });
  const actions = await getTranslations({
    locale: params.locale,
    namespace: 'Auth.PasswordReset.actions',
  });
