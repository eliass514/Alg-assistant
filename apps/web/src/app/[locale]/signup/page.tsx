...
export async function generateMetadata({ params }: PageProps) {
  const t = await getTranslations({ locale: params.locale, namespace: 'Auth.Signup.meta' });
...
export default async function SignupPage({ params }: PageProps) {
  const page = await getTranslations({ locale: params.locale, namespace: 'Auth.Signup.page' });
  const actions = await getTranslations({
    locale: params.locale,
    namespace: 'Auth.Signup.actions',
  });
